...
import com.shrinkspree.shrinkspree.dtos.ClickEventDTO;
import com.shrinkspree.shrinkspree.dtos.UrlMappingDTO;
...
import com.shrinkspree.shrinkspree.repository.ClickEventRepository;
import com.shrinkspree.shrinkspree.repository.UrlMappingRepository;
...
public class UrlMappingService {
    ...
    private String generateShortUrl() {
        ...
        for(int i = 0; i < 8; i++){
            shortUrl.append(characters.charAt(random.nextInt(characters.length()))); // Itna hi tha 🙂
        }
